...
// Sanity `page` doc has no sections yet. As marketing composes the about
// page in Studio, the Sanity-driven render takes over and this is
// progressively deleted. See DEFERRED.md.
