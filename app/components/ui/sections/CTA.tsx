        ...
        <div className="w-full md:w-3/5 grid place-items-center md:place-items-start ">
          ...
          <div className="flex flex-col gap-6 ">
            <p className="text-[#898D91E6] xl:text-2xl w-[300px] xl:w-[400px] mx-auto t 2xl:leading-relaxed">
              Join Liqtra and experience the future of DeFi portfolio management.
              Maximize yields, minimize risks, and let AI do the heavy lifting.
            </p>
